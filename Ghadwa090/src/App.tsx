...
const queryClient = new QueryClient({
    defaultOptions: {
        queries: {
            staleTime: 5 * 60 * 1000, // 5 minutes cache before considering stale
            refetchOnWindowFocus: false, // Minimize egress on tab switches
...
import { CategoriesGrid } from '@/presentation/features/home/CategoriesGrid';
...
import { AmbassadorsPage } from '@/presentation/pages/AmbassadorsPage';
// import { AllChefsPage } from '@/presentation/pages/AllChefsPage';
...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            { path: 'ambassadors', element: <AmbassadorsPage /> },
        ]
    }
]);
